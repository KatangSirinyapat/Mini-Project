...
router.route('/fis')
    ...
    .post((req, res) => {
        ...
        allnewstdCom.date = req.body.date
...
router.route('/fis/:comment_id')
    ...
    .put((req, res) => {
        ...
        if (id >= 0) {
            ...
            commentsFIS.list[id].date = req.body.date
...
router.route('/fht/:comment_id')
    ...
    .put((req, res) => {
        ...
        if (id >= 0) {
            ...
            commentsFHT.list[id].date = req.body.date
...
router.route('/fte/:comment_id')
    ...
    .put((req, res) => {
        ...
        if (id >= 0) {
            ...
            commentsFTE.list[id].date = req.body.date
...
router.route('/coc/:comment_id')
    ...
    .put((req, res) => {
        ...
        if (id >= 0) {
            ...
            commentsCOC.list[id].date = req.body.date
